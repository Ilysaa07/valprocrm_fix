...
export default function PayrollPDFGenerator({ payroll }: PayrollPDFGeneratorProps) {
  ...
  return (
    <button
      onClick={() => generatePDF()}
      className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors w-full sm:w-auto"
    >
